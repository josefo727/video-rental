                ...
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left">
                                @lang('crud.videos.inputs.attributes')
                            </th>
                            <th class="text-left">
                                @lang('crud.videos.inputs.original_language')
                            </th>
                            <th class="text-left">
                                @lang('crud.videos.inputs.classification')
                            </th>
                            <th class="text-left">
                                @lang('crud.videos.inputs.series_id')
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $video->original_language ?? '-' }}</td>
                            <td>{{ $video->classification ?? '-' }}</td>
                            <td>{{ optional($video->series)->name ?? '-' }}</td>
